...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-11 alert alert-secondary" style="text-align: center"><?php echo $qry['title'] ?></div>
		<button class="btn btn-primary bt-sm" id="new_question" style="float: right"><i class="fa fa-plus"></i>	Add Question</button>
		<button class="btn btn-primary bt-sm" id="new_student" style="float: right"><i class="fa fa-plus"></i>	Add Student</button>
		<br>
		<br>
		<div class="card col-md-6 mr-2" style="float:left; text-align: center">
	...
	<div class="card col-md-5" style="float:left; text-align: center">
			<div class="card-header">
				Students
			</div>
			<div class="card-body">
